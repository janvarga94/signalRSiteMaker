...
document.onkeydown = function (e) {
    ...
    if (Keyboard.keyToBool['CONTROL'] && Keyboard.keyToBool['C']) {
        if (selected.el != document.body)
            Clipboard = selected.el.outerHTML;
    }
    if (Keyboard.keyToBool['CONTROL'] && Keyboard.keyToBool['X']) {
        if (selected.el != document.body) {
            Clipboard = selected.el.outerHTML;
            var parent = selected.el.parentElement;
            parent.removeChild(selected.el);
    ...
    if (Keyboard.keyToBool['CONTROL'] && Keyboard.keyToBool['V']) {
        if (Clipboard != null) {
    ...
    if (Keyboard.keyToBool['SHIFT'] && Keyboard.keyToBool['S']) {
