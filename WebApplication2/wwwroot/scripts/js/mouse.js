document.body.onmousedown = function (e) {
    ...
    newEl.style.border = "dotted 1px black";
...
document.body.onmousemove = function (ev) {
    ...
    if (mouseDown.leftTopRot || mouseDown.rightBottomRot) {
...
document.body.onmouseup = function (ev) {
    ...
    if (distanceX * distanceY < 2000 && newEl != null) {
